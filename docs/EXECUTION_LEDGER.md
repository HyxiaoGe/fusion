...
- #129 基线独立复现 11 条“分别／个别／特别／区别”等普通词触发撤权，两路径同受影响。候选修复收窄裸「别」和工具名禁用的跨词匹配，真否定继续硬约束；新增目标测试修前 77 failed、10 passed，修后 91 passed。原 33 条 rules 盲测修前后均 14/33，完整 47 条均 18/47 且逐条输出无变化。
