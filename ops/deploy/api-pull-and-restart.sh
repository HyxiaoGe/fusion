...
export AGENT_MAX_STEPS="${DEPLOY_AGENT_MAX_STEPS:-${AGENT_MAX_STEPS:-64}}"
export AGENT_MAX_TOOL_CALLS="${DEPLOY_AGENT_MAX_TOOL_CALLS:-${AGENT_MAX_TOOL_CALLS:-200}}"
export AGENT_TOTAL_TIMEOUT="${DEPLOY_AGENT_TOTAL_TIMEOUT:-${AGENT_TOTAL_TIMEOUT:-1800}}"
...
export MCP_MAX_TOOL_CALLS_PER_SERVER_PER_RUN="${DEPLOY_MCP_MAX_TOOL_CALLS_PER_SERVER_PER_RUN:-${MCP_MAX_TOOL_CALLS_PER_SERVER_PER_RUN:-64}}"
